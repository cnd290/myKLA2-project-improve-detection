...
(function(global, factory) {
...
}(this, (function(exports, tfc, tfOps) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var OperationMapper = /** @class */ (function() {
        ...
        OperationMapper.prototype.mapNode = function(node) {
            ...
            var newNode = {
                ...
                inputNames: (node.input || []).map(function(input) { return input.startsWith('^') ? input.substr(1) : input; }),
                inputs: [],
                children: [],
                inputParams: {},
                attrParams: {},
        ...
        OperationMapper.prototype.mapFunction = function(functionDef) {
            ...
            functionDef.signature.outputArg.forEach(function(output) {
                var _a = getNodeNameAndIndex(returnNodeMap[output.name]),
                    nodeName = _a[0],
                    index = _a[1];
                var node = nodes[nodeName];
                if (node != null) {
    ...
    function fusedConvAndDepthWiseParams(node, tensorMap, context) {
        var _a = getParamValue('fusedOps', node, tensorMap, context),
            extraOp = _a[0],
            activationFunc = _a[1];
        ...
        var _b = getParamValue('args', node, tensorMap, context),
            biasArg = _b[0],
            preluArg = _b[1];
        return {
            stride: stride,
        ...
        ExecutionContext.prototype.contextIdforContexts = function(contexts) {
            return contexts ?
                ...
                .map(function(context) {
                    return (context.id === 0 && context.iterationId === 0) ?
                        '' :
                ...
                return this._inputs.map(function(node) {
                    return {
                        ...
                        shape: node.attrParams['shape'] ?
                            node.attrParams['shape'].value : undefined,
                        dtype: node.attrParams['dtype'] ?
                            node.attrParams['dtype'].value : undefined
                    };
                });
            },
            enumerable: true,
            ...
            Object.keys(inputs).forEach(function(name) {
                ...
                if (node.attrParams['shape'] && node.attrParams['shape'].value) {
                    ...
                    tfc.util.assert(match, function() {
                        return "The shape of dict['" + node.name + "'] provided in " +
                ...
                if (node.attrParams['dtype'] && node.attrParams['dtype'].value) {
                    tfc.util.assert(input.dtype === node.attrParams['dtype'].value, function() {
                        return "The dtype of dict['" + node.name + "'] provided in " +
